...
export const YourWallet = ({supportedTokens} : YourWalletProps) => {
    ...
    const oilLiterUSD = useOilPrice()/ 158.987
    ...
    const handlePayFee = () => {
        ...
        if(num1 > 0)
        {
            ...
            return approveAndSend(amountAsWei.toString())//,supportedTokens[0].address,stationAddress)
        }
        // const amountAsWei = utils.parseEther(fee.toString())
    ...
    const formattedOilPrice: number = oilPrice ? parseFloat(formatUnits(oilPrice,18)) : 0
    ...
    return (<Box>
        ...
        <h1>
            ...
            <div>
                ...
                <br/>
                A Liter: {formattedOilPrice/158.987}
